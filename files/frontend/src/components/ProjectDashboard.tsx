          ...
          <div className="space-y-4">
            {projects.map((project) => (
              <div
                ...
                className="hover:bg-blue-50 transition-colors duration-200 rounded-lg p-4 border border-gray-200 bg-white shadow-md"
              >
                  ...
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <Title level={4} className="m-0 truncate text-gray-900">
                          {project.name}
                        </Title>
                      ...
                      <Text type="secondary" className="text-sm text-gray-700 mb-2">
